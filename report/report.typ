...
#pagebreak()
#outline(title: [ЗМІСТ], indent: auto)
...
#simple-table(
  ...
  (
    ...
    [`logFood`], [створення елемента журналу], [підтримка швидкого логування через natural language],
...
#screenshot("assets/screenshots/dashboard.png", [Головна панель NutriAI зі щоденними показниками, streak та quick actions.])

#screenshot("assets/screenshots/food-log.png", [Сторінка food log для контролю фактичного споживання продуктів за день.])

#screenshot("assets/screenshots/meal-plans.png", [Модуль планування харчування з weekly meal plan та shopping list.])

#screenshot("assets/screenshots/foods.png", [Каталог продуктів із фільтрами, фаворитами та діями для логування/планування.])

#screenshot("assets/screenshots/goals.png", [Сторінка керування цілями користувача.])

#screenshot("assets/screenshots/profile.png", [Профіль користувача з персональними параметрами та цільовими значеннями.])

#screenshot("assets/screenshots/assistant.png", [AI-асистент із збереженою розмовою та відображенням інструментальної активності.])
