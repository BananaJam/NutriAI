...
#let topic = "Розробка моделі планування харчування та моніторингу споживання калорій з інтегрованим ШІ-асистентом"
#let city = "Львів"
...
#let abbreviations-page() = [
  ...
  #v(1em)
  #no-indent[
    *ШІ* — штучний інтелект; сукупність методів, моделей і програмних засобів, що забезпечують імітацію окремих інтелектуальних функцій людини, зокрема аналіз вхідних даних, побудову висновків, генерацію відповідей і підтримку прийняття рішень у межах інформаційної системи. #linebreak()
