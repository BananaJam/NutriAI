...
#numbered-line(
  ...
  [
    ...
    персоналізованих AI-асистентів, tool calling, агентних SDK, моделювання даних і
    full-stack архітектури веб-застосунків.
  ],
)
...
#v(0.15em)
...
#enum(
  [Проаналізувати предметну область систем моніторингу харчування, планування раціону та прикладних AI-асистентів.],
  [Спроєктувати доменну модель користувача, профілю, каталогу продуктів, журналу харчування, планів, цілей і повідомлень AI-чату.],
  ...
  [Обґрунтувати архітектуру full-stack веб-застосунку на основі Next.js, Bun, Prisma, PostgreSQL та Elysia.],
  [Реалізувати модулі профілю, каталогу продуктів, журналу харчування, планів, цілей, аналітики та налаштувань користувача.],
  [Реалізувати AI-асистента з контрольованим викликом інструментів і доступом до даних застосунку.],
...
#numbered-line(
  ...
  [
    ER-діаграма доменної моделі; схема архітектури системи; схема роботи AI-асистента
    з викликом інструментів; скріншоти Dashboard, журналу харчування, планів, цілей,
    профілю, AI-чату та лабораторії агентних SDK; таблиці результатів benchmark-порівняння.
  ],
)
...
#normal-table(
  ...
  (
    ...
    [Виконано],
    [2],
    [Аналіз предметної області, існуючих систем моніторингу харчування та підходів до побудови AI-асистентів.],
    [15.03.2026],
    [Виконано],
    [3],
    ...
    [Виконано],
    [5],
    [Реалізація AI-асистента, інтеграція tool calling, підготовка лабораторії агентних SDK і benchmark-сценаріїв.],
    [18.05.2026],
    [Виконано],
    [6],
    [Тестування, формування demo-даних, знімання скріншотів, оформлення пояснювальної записки, README та додатків.],
    [01.06.2026],
    [Виконано],
  ),
)
